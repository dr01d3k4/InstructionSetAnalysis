...
class x86(ArchitectureBase):
	...
	def decode(self, bytes, skipNopsAfterJumps, firstByteOffset = 0, instructionLimit = 1):
		return decoder.decode(bytes, skipNopsAfterJumps, firstByteOffset, instructionLimit);
